 ...
 */
     ...
     */
    static normalize(number, digits) {
        let result = "";
    ...
    */
    ...
    static toLocalizedDateString(date) {
    ...
    static getTimeText(date) {
        ...
        if (today.toString() === date.toString()) {
            ...
            if (date.toString() === today.toString()) {
                return App.getBundle().tasks.TOMORROW;
            }
            else {
                today.setDate(today.getDate() - 2);
                if (date.toString() === today.toString()) {
                    return App.getBundle().tasks.YESTERDAY;
                }
